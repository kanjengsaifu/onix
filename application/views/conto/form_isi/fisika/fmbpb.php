 ...
 * Date: 3/26/15
 * Time: 3:37 PM
 * Pengisian Analisis Petrografi Batuan
 */
            ...
            <?php if(!empty($nilai['komposisi_mineral'])): ?>
                <?php foreach($nilai['komposisi_mineral'] as $komposisi_mineral): ?>
                    <tr id="mineral-<?php echo $komposisi_mineral->id; ?>">
                        ...
                        <td><button type="button" class="btn btn-xs btn-delete-mineral-fmbmn btn-danger" data-id="<?php echo $komposisi_mineral->id; ?>"><i class="fa fa-times"></i> hapus</button></td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
        </tbody>
