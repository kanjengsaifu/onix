...
$pdf->SetX(2);
$pdf->Cell(0,0,'A N A L I S I S   M I N E G R A F I',0,0,'C');
$pdf->Ln(1);
...
$detail_conto_fisika = $this->hasil_analisis_m->get_detail_conto_fisika($id_conto, 'FMBMN');
/*
 * DESKRIPSI PETROGRAFI
 */
$pdf->Ln(1);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(3.1,1,'Deskripsi Mikroskopik:');
$pdf->Ln(1);
$pdf->SetFont('Arial','',9);
$pdf->SetFont('Arial','',9);
