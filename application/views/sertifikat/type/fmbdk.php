...
$pdf->Cell(0,0,'HASIL ANALISIS DERAJAT KEMAGNETAN',0,0,'C');
$pdf->Ln(1);
...
$pdf->Cell(4.7,1,'KODE CONTO',1,0,'C');
$pdf->Cell(7,1,'DERAJAT KEMAGNETAN (%)',1,0,'C');
// body
$i = 1;
$pdf->Ln();
$pdf->SetFont('Arial','',12);
...
foreach($list_conto as $conto):
    ...
    $pdf->Cell(4.7,1,$hasil_analisis->kode_conto.'/'.$i++,1,0,'C');
    $pdf->Cell(7,1,$nilai[0],1,0,'C');
    $pdf->Ln();
endforeach;
