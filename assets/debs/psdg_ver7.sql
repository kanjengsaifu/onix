...
--
-- Host: localhost
-- Generation Time: Oct 16, 2014 at 07:55 PM
...
('20140800001', 'nl001knl1014', '2014-10-13 18:32:34', NULL, 0, 0, NULL),
('20140800002', 'nl001knl1014', '2014-10-15 09:12:15', NULL, 0, 1, NULL),
('20140800003', 'nl001knl1014', '2014-10-15 09:12:19', NULL, 0, 0, NULL),
('20140800004', 'nl002knl1014', '2014-10-13 18:33:08', NULL, 0, 1, NULL),
('20140800005', 'nl002knl1014', '2014-10-14 03:45:02', NULL, 0, 0, NULL),
('20140800006', 'nl002knl1014', '2014-10-14 07:11:57', NULL, 0, 0, NULL),
('20140800009', 'pb001kpb1014', '2014-10-14 07:17:38', NULL, 0, 0, NULL),
('20140800012', 'bb001fmb1014', '2014-10-15 11:12:38', '0', 0, 1, '');
...
INSERT INTO `detail_conto_fisika` (`id`, `id_conto`, `id_type_analisis`, `foto_1`, `foto_2`, `deskripsi_1`, `deskripsi_2`, `nilai`) VALUES
(1, '20140800012', 'fmbab', '2014080001211.jpg', '2014080001212.jpg', 'deskripsi 1', 'deskripsi 2', NULL),
(2, '20140800012', 'fmbbj', '', '', 'berat jenis 1', 'berat jenis 2', 48),
(3, '20140800012', 'fmbdk', '', '', '', '', 22),
(4, '20140800012', 'fmbrt', '2014080001241.jpg', '', '', '', 28);
...
CREATE TABLE IF NOT EXISTS `hasil_analisis` (
  ...
  UNIQUE KEY `nomor_analisis` (`nomor_analisis`),
...
INSERT INTO `hasil_analisis` (`id_analisis`, `nomor_analisis`, `jenis_contoh`, `jumlah_contoh`, `kode_conto`, `lokasi`, `tanggal_terima`, `tanggal_daftar`, `id_pegawai`, `id_lab`, `biaya`, `id_pemohon`, `preparasi`, `is_selesai`, `created_at`) VALUES
('bb001fmb1014', '20140800012', 'Air', 3, 'ED', 336, '2014-10-03', '2014-10-15', '01003658841253639', 'fmb', 0, 2, 1, 0, '2014-10-15 11:12:08'),
('nl001knl1014', '20140800001', 'pasir', 3, 'SSA', 2, '2014-10-02', '2014-10-14', '01003658841253639', 'knl', 0, 2, 1, 0, '2014-10-13 18:32:34'),
('nl002knl1014', '20140800004', 'Dedek', 5, 'SSd', 304, '2014-10-08', '2014-10-14', '01003658841253639', 'knl', 0, 2, 1, 0, '2014-10-13 18:33:08'),
('pb001kpb1014', '20140800009', 'Pasir', 3, 'SSD', 284, '2014-10-01', '2014-10-14', '01003658841253639', 'kpb', 0, 2, 1, 0, '2014-10-14 07:17:38');
...
CREATE TABLE IF NOT EXISTS `metoda` (
  ...
  `nama` varchar(50) NOT NULL,
  `id_laboratorium` varchar(3) NOT NULL,
...
(10, 'Viscometer', 'knl'),
(11, 'Volumetri', 'knl'),
(12, 'Ion Chromotografi', 'knl'),
(13, 'Micro Plasma', 'knl'),
(14, 'Mercury Analyzer Zeeman', 'knl'),
(15, 'CETAC', 'knl'),
(16, 'DMA', 'knl'),
(17, ' SNI 13 -3496- 1996', 'knl'),
(18, 'ASTM C 25-99', 'knl'),
(19, 'ASTM C1301-95 (Reapp2009)', 'knl'),
(20, 'SNI 7574 - 2010', 'knl'),
(21, 'K - III-32.03-IKNL', 'knl'),
(22, ' SNI 06-2603-1992', 'knl'),
(23, ' KF-.III.32.20 IKNL', 'knl'),
(24, ' ASTM E 247-96-1998', 'knl'),
(25, ' ASTM D 4369. 2013  ', 'knl'),
(26, ' BS -1916 Part 14:1963', 'knl'),
(27, ' KF-.III.32.18  IKNL', 'knl'),
(32, 'ASTM D 4369. 2013', 'knl'),
(33, 'BS -1916 Part 14:1963', 'knl'),
(34, 'KF -III-32-22-IKNL', 'knl'),
(35, 'ASTM E 1081 - 95 a -1998', 'knl'),
(118, 'SNI 06-6989-11-2004', 'kpb'),
(119, 'SNI 06-6989-12-2004', 'kpb'),
(120, 'SNI 06-6989-13-2004', 'kpb'),
(121, 'SNI 06-2603-1992', 'kpb'),
(122, 'Mahon, Ellis,A.J,1977', 'kpb'),
(128, 'SNI 06-2481-1991', 'kpb'),
(129, 'SNI 6989.34: 2009', 'kpb'),
(130, 'SNI 06-2523 – 1991', 'kpb'),
(131, 'SNI 06-6989.12-2004', 'kpb'),
(132, 'SNI 06-6989.56.2005', 'kpb'),
(153, 'Picarro L 2120 -i  Isotopic H2O', 'kpb'),
(154, 'SNI 06-2428-1991', 'kpb'),
(155, 'Zeeman Mercury  Spectrometer -  RA 915', 'kpb'),
(156, ' SNI 06-6989-54-1991', 'kpb'),
(157, 'Micro  Plasma-  Agilent 4100', 'kpb'),
(158, 'SNI 06 -2479-1991', 'kpb'),
(159, 'SNI 06 -6989- 30- 2005', 'kpb'),
(160, 'SNI 06 -6876-2002', 'kpb'),
(161, 'SNI 06 -2482-1991', 'kpb'),
(162, 'IC-  Dionex ICS-1600', 'kpb');
...
(124, '20140800001', 'KNLKM04', 62, '%', 2, NULL),
(125, '20140800001', 'KNLKM15', 4, NULL, 2, NULL),
(126, '20140800001', 'KNLKM16', 65, NULL, 1, NULL),
(127, '20140800004', 'KNLKM07', 34, '‰', 2, NULL),
(128, '20140800004', 'KNLKM08', 44, NULL, 2, NULL),
(129, '20140800004', 'KNLKM15', 34, NULL, 2, NULL),
(130, '20140800004', 'KNLKM16', 66, '%', 1, NULL),
(131, '20140800005', 'KNLKM07', 23, '°C', 2, NULL),
(132, '20140800005', 'KNLKM08', 0, NULL, 2, NULL),
(133, '20140800005', 'KNLKM15', 0, NULL, 2, NULL),
(134, '20140800005', 'KNLKM16', 0, NULL, 1, NULL),
(135, '20140800006', 'KNLKM07', 0, NULL, 2, NULL),
(136, '20140800006', 'KNLKM08', 0, NULL, 2, NULL),
(137, '20140800006', 'KNLKM15', 0, NULL, 2, NULL),
(138, '20140800006', 'KNLKM16', 0, NULL, 1, NULL),
(139, '20140800009', 'KPBIA01', 3, '°C', 0, NULL),
(140, '20140800009', 'KPBIA02', 0, NULL, 0, NULL),
(141, '20140800002', 'KNLKM04', 52, 'meg%', 2, NULL),
(142, '20140800002', 'KNLKM15', 74, 'ppm', 2, NULL),
(143, '20140800002', 'KNLKM16', 45.56, 'meg%', 1, NULL),
(144, '20140800003', 'KNLKM04', 0, NULL, 2, NULL),
(145, '20140800003', 'KNLKM15', 0, NULL, 2, NULL),
(146, '20140800003', 'KNLKM16', 0, NULL, 1, NULL);
...
ALTER TABLE `detail_conto_fisika`
  ADD CONSTRAINT `conto_fisika` FOREIGN KEY (`id_conto`) REFERENCES `conto` (`id_conto`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `metoda`
  ADD CONSTRAINT `metoda_ibfk_1` FOREIGN KEY (`id_laboratorium`) REFERENCES `laboratorium` (`id_lab`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `metoda_parameter`
--
ALTER TABLE `metoda_parameter`
  ADD CONSTRAINT `metoda_parameter_ibfk_1` FOREIGN KEY (`id_metoda`) REFERENCES `metoda` (`id_metoda`) ON DELETE CASCADE ON UPDATE CASCADE;
